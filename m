Return-Path: <linux-kbuild+bounces-13246-lists+linux-kbuild=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-kbuild@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id EBdmJ3OwCmog5wQAu9opvQ
	(envelope-from <linux-kbuild+bounces-13246-lists+linux-kbuild=lfdr.de@vger.kernel.org>)
	for <lists+linux-kbuild@lfdr.de>; Mon, 18 May 2026 08:23:47 +0200
X-Original-To: lists+linux-kbuild@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [IPv6:2600:3c04:e001:36c::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id E39BA566A64
	for <lists+linux-kbuild@lfdr.de>; Mon, 18 May 2026 08:23:46 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id 7685F301BA7B
	for <lists+linux-kbuild@lfdr.de>; Mon, 18 May 2026 06:22:46 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 796AA3DEFF7;
	Mon, 18 May 2026 06:21:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=tngtech.com header.i=@tngtech.com header.b="QZIYOBTh"
X-Original-To: linux-kbuild@vger.kernel.org
Received: from mailgw02.zimbra-vnc.de (mailgw02.zimbra-vnc.de [148.251.102.236])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id C7A2B3DF019;
...
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1779085307; cv=none; b=aQFo7hPfcpLwnRRf3uLPtmN9uTjYLVPCAJ9pu0UbbKfY7MrybCNoNn/Nnqof0t1MitrsectfPyUErV6UTnLZn8hyR8vb2J2R2YDTPnMJ942gK/Mrc8nRORg3Eski8eWAWCA5ErQtIqBWVvnGUE+j5Ss7nZtm/C64oewLzy7OSA0=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1779085307; c=relaxed/simple;
	bh=4NmpOJ6YtHDRQBnpBkU+Dlewh2FQzXPfieP9CTF3b1U=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=KS9rSP4wmHHWMJ10CPTWa//vaQ1ohySFcrGLIkd1TgqbsDKl2Q7XyCdltYKzl0AcWkYi8Spkdr1epYkUsAj3fa28q8ozESP+5Ajk3msFuBkm7wRp8oDffMp+N9tSQDfMpnYcF60rpbCVXXbFDD7hlrknQXcJAvKhMthQ1n55/vk=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=tngtech.com; spf=pass smtp.mailfrom=tngtech.com; dkim=pass (2048-bit key) header.d=tngtech.com header.i=@tngtech.com header.b=QZIYOBTh; arc=none smtp.client-ip=148.251.102.236
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=tngtech.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=tngtech.com
Received: from zmproxy.tng.vnc.biz (zimbra-vnc.tngtech.com [35.234.71.156])
	by mailgw02.zimbra-vnc.de (Postfix) with ESMTPS id 63EA0200CE;
	Mon, 18 May 2026 08:21:31 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by zmproxy.tng.vnc.biz (Postfix) with ESMTP id 2E48A1F89A8;
	Mon, 18 May 2026 08:21:31 +0200 (CEST)
Received: from zmproxy.tng.vnc.biz ([127.0.0.1])
 by localhost (zmproxy.tng.vnc.biz [127.0.0.1]) (amavis, port 10032)
 with ESMTP id TU_fzY04TXDm; Mon, 18 May 2026 08:21:28 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by zmproxy.tng.vnc.biz (Postfix) with ESMTP id CB77A1FACCB;
	Mon, 18 May 2026 08:21:28 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.10.3 zmproxy.tng.vnc.biz CB77A1FACCB
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=tngtech.com;
	s=B14491C6-869D-11EB-BB6C-8DD33D883B31; t=1779085288;
	bh=FA3MeeJSL2kCLS6ILJNS/yPLeIWjDcAPSqTtxKoAquQ=;
	h=From:To:Subject:Date:Message-ID:MIME-Version;
	b=
X-Virus-Scanned: amavis at zmproxy.tng.vnc.biz
Received: from zmproxy.tng.vnc.biz ([127.0.0.1])
 by localhost (zmproxy.tng.vnc.biz [127.0.0.1]) (amavis, port 10026)
 with ESMTP id ZnIJfU4LlwOX; Mon, 18 May 2026 08:21:28 +0200 (CEST)
Received: from luis-Precision-5480.. (ipservice-092-209-239-167.092.209.pools.vodafone-ip.de [92.209.239.167])
	by zmproxy.tng.vnc.biz (Postfix) with ESMTPSA id 6E6C41F89A8;
	Mon, 18 May 2026 08:21:28 +0200 (CEST)
...
Subject: [PATCH v7 14/15] scripts/sbom: add unit tests for command parsers
Date: Mon, 18 May 2026 08:21:01 +0200
Message-ID: <20260518062102.2051814-15-luis.augenstein@tngtech.com>
...
X-Spamd-Result: default: False [-0.66 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-13246-lists,linux-kbuild=lfdr.de];
	DBL_BLOCKED_OPENRESOLVER(0.00)[tor.lore.kernel.org:helo,tor.lore.kernel.org:rdns,mkuboot.sh:url,tngtech.com:email,tngtech.com:mid,tngtech.com:dkim,syscallnr.sh:url,orc_hash.sh:url,xen-hypercalls.sh:url,syscallhdr.sh:url];
...
+        errors =3D sbom_logging._error_logger._message_counts # type: igno=
re
...
+            cmd =3D "gcc   -o arch/x86/tools/relocs arch/x86/tools/relocs_=
32.o arch/x86/tools/relocs_64.o arch/x86/tools/relocs_common.o"
+            expected =3D "arch/x86/tools/relocs_32.o arch/x86/tools/relocs=
_64.o arch/x86/tools/relocs_common.o"
...
+    # ld command tests
+    def test_ld(self):
+        cmd =3D r'ld -o arch/x86/entry/vdso/vdso64.so.dbg -shared --hash-s=
tyle=3Dboth --build-id=3Dsha1 --no-undefined  --eh-frame-hdr -Bsymbolic -z =
noexecstack -m elf_x86_64 -soname linux-vdso.so.1 -z max-page-size=3D4096 -=
T arch/x86/entry/vdso/vdso.lds arch/x86/entry/vdso/vdso-note.o arch/x86/ent=
ry/vdso/vclock_gettime.o arch/x86/entry/vdso/vgetcpu.o arch/x86/entry/vdso/=
vgetrandom.o arch/x86/entry/vdso/vgetrandom-chacha.o; if readelf -rW arch/x=
86/entry/vdso/vdso64.so.dbg | grep -v _NONE | grep -q " R_\w*_"; then (echo=
 >&2 "arch/x86/entry/vdso/vdso64.so.dbg: dynamic relocations are not suppor=
ted"; rm -f arch/x86/entry/vdso/vdso64.so.dbg; /bin/false); fi'
...
+            registry =3D CommandParserRegistry.create()
+            cmd =3D r'ld -o arch/x86/entry/vdso/vdso64.so.dbg -shared --ha=
sh-style=3Dboth --build-id=3Dsha1 --no-undefined  --eh-frame-hdr -Bsymbolic=
 -z noexecstack -m elf_x86_64 -soname linux-vdso.so.1 -z max-page-size=3D40=
96 -T arch/x86/entry/vdso/vdso.lds arch/x86/entry/vdso/vdso-note.o arch/x86=
/entry/vdso/vclock_gettime.o arch/x86/entry/vdso/vgetcpu.o arch/x86/entry/v=
dso/vgetrandom.o arch/x86/entry/vdso/vgetrandom-chacha.o; if readelf -rW ar=
ch/x86/entry/vdso/vdso64.so.dbg | grep -v _NONE | grep -q " R_\w*_"; then (=
echo >&2 "arch/x86/entry/vdso/vdso64.so.dbg: dynamic relocations are not su=
pported"; rm -f arch/x86/entry/vdso/vdso64.so.dbg; /bin/false); fi'
+            expected =3D "arch/x86/entry/vdso/vdso-note.o arch/x86/entry/v=
dso/vclock_gettime.o arch/x86/entry/vdso/vgetcpu.o arch/x86/entry/vdso/vget=
random.o arch/x86/entry/vdso/vgetrandom-chacha.o"
+            self._assert_parsing(cmd, expected, registry)
...
+        cmd =3D "cp arch/arm64/boot/Image arch/arm64/boot/vmlinux.bin; tru=
ncate -s $$(hexdump -s16 -n4 -e '\"%u\"' arch/arm64/boot/Image) arch/arm64/=
boot/vmlinux.bin"
+        expected =3D "arch/arm64/boot/Image"
+        self._assert_parsing(cmd, expected)
+
+    # rustc command tests
+    def test_rustc(self):
...
+        cmd =3D "bash ../scripts/mkuboot.sh -A arm -O linux -C none -T ker=
nel -a 0x8000 -e 0x8000 -n 'Linux-6.15.0' -d arch/arm/boot/zImage arch/arm/=
boot/uImage"
+        expected =3D "arch/arm/boot/zImage"
+        self._assert_parsing(cmd, expected)
+
+    # syscallnr.sh command tests
+    def test_syscallnr(self):
+        cmd =3D "sh ../arch/arm/tools/syscallnr.sh ../arch/arm/tools/sysca=
ll.tbl arch/arm/include/generated/asm/unistd-nr.h"
+        expected =3D "../arch/arm/tools/syscall.tbl"
+        self._assert_parsing(cmd, expected)
+
+    # gen-kernel-hwcaps.sh command tests
+    def test_gen_kernel_hwcaps(self):
+        cmd =3D "/bin/sh -e ../arch/arm64/tools/gen-kernel-hwcaps.sh ../ar=
ch/arm64/include/uapi/asm/hwcap.h > arch/arm64/include/generated/asm/kernel=
-hwcap.h"
+        expected =3D "../arch/arm64/include/uapi/asm/hwcap.h"
+        self._assert_parsing(cmd, expected)
+
...
+        cmd =3D "arch/arm64/kernel/vdso32/../../../arm/vdso/vdsomunge arch=
/arm64/kernel/vdso32/vdso.so.raw arch/arm64/kernel/vdso32/vdso32.so.dbg"
+        expected =3D "arch/arm64/kernel/vdso32/vdso.so.raw"
+        self._assert_parsing(cmd, expected)
+
