Return-Path: <linux-kbuild+bounces-13079-lists+linux-kbuild=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-kbuild@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id AJYIOUnP/GlhTwAAu9opvQ
	(envelope-from <linux-kbuild+bounces-13079-lists+linux-kbuild=lfdr.de@vger.kernel.org>)
	for <lists+linux-kbuild@lfdr.de>; Thu, 07 May 2026 19:43:37 +0200
X-Original-To: lists+linux-kbuild@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [172.105.105.114])
	by mail.lfdr.de (Postfix) with ESMTPS id 551A34ED036
	for <lists+linux-kbuild@lfdr.de>; Thu, 07 May 2026 19:43:36 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id 04C8A309F3DB
	for <lists+linux-kbuild@lfdr.de>; Thu,  7 May 2026 17:40:26 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 1216D47A0DC;
	Thu,  7 May 2026 17:39:50 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=tngtech.com header.i=@tngtech.com header.b="Aa7tvQok"
X-Original-To: linux-kbuild@vger.kernel.org
Received: from mailgw02.zimbra-vnc.de (mailgw02.zimbra-vnc.de [148.251.102.236])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id 85AC947798E;
...
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1778175590; cv=none; b=eTyTS2GgBFyEGQ568eG5PtIaLWyCbgY4f0moVKHMZc7Qb1j9DZtaJ8nYmn0chpk8ZtZlHFZM15g1mbBlYOD17iAV+VoIG/nnfyCdmmIVxFw+yeGIGcxceyBnRGzpAULM9lrWx8XMaj4UYu0xjDreYKrNITVL11um2FFTXbBCBFA=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1778175590; c=relaxed/simple;
	bh=mAWcvr2gDHHwM66m2IwQ3bCgvM2D5SvZwJ0/1XJ0FHE=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=L19t8nJGP20rCA4j/lFooAiILmGD8q7nc9c5UOl9yjuOq/2BQz/CnXprByHNwnhT6ewIqHcuhz4wx0DH0Sfk5IFmL93/H6soygTmt/iwIRb0s8wREtfnRkWAGlSL/cCX/gGKWdNuLAxxgqncBXeAGo/4BXvftScCGspxPWi0okI=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=tngtech.com; spf=pass smtp.mailfrom=tngtech.com; dkim=pass (2048-bit key) header.d=tngtech.com header.i=@tngtech.com header.b=Aa7tvQok; arc=none smtp.client-ip=148.251.102.236
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=tngtech.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=tngtech.com
Received: from zmproxy.tng.vnc.biz (zimbra-vnc.tngtech.com [35.234.71.156])
	by mailgw02.zimbra-vnc.de (Postfix) with ESMTPS id D09A8200B5;
	Thu,  7 May 2026 19:39:44 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by zmproxy.tng.vnc.biz (Postfix) with ESMTP id B95721FB09C;
	Thu,  7 May 2026 19:39:44 +0200 (CEST)
Received: from zmproxy.tng.vnc.biz ([127.0.0.1])
 by localhost (zmproxy.tng.vnc.biz [127.0.0.1]) (amavis, port 10032)
 with ESMTP id CXib1jIo-aiE; Thu,  7 May 2026 19:39:42 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by zmproxy.tng.vnc.biz (Postfix) with ESMTP id 8FE941FB0E6;
	Thu,  7 May 2026 19:39:42 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.10.3 zmproxy.tng.vnc.biz 8FE941FB0E6
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=tngtech.com;
	s=B14491C6-869D-11EB-BB6C-8DD33D883B31; t=1778175582;
	bh=wjVovCS0ZX2hf4yps30ot8kduZc0aUZK2QcXuXqTXQU=;
	h=From:To:Subject:Date:Message-ID:MIME-Version;
	b=
X-Virus-Scanned: amavis at zmproxy.tng.vnc.biz
Received: from zmproxy.tng.vnc.biz ([127.0.0.1])
 by localhost (zmproxy.tng.vnc.biz [127.0.0.1]) (amavis, port 10026)
 with ESMTP id o2D7kT4fy0w6; Thu,  7 May 2026 19:39:42 +0200 (CEST)
Received: from luis-Precision-5480.. (ipservice-092-209-239-167.092.209.pools.vodafone-ip.de [92.209.239.167])
	by zmproxy.tng.vnc.biz (Postfix) with ESMTPSA id 2F4A21FB1CB;
	Thu,  7 May 2026 19:39:42 +0200 (CEST)
...
Subject: [PATCH v6 14/15] scripts/sbom: add unit tests for command parsers
Date: Thu,  7 May 2026 19:38:26 +0200
Message-ID: <20260507173827.70949-15-luis.augenstein@tngtech.com>
...
X-Spamd-Result: default: False [-0.66 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-13079-lists,linux-kbuild=lfdr.de];
	DBL_BLOCKED_OPENRESOLVER(0.00)[gen_initramfs.sh:url,tngtech.com:email,tngtech.com:mid,tngtech.com:dkim,tor.lore.kernel.org:helo,tor.lore.kernel.org:rdns,link-vmlinux.sh:url,syscalltbl.sh:url,mkcapflags.sh:url,orc_hash.sh:url];
...
+            registry =3D CommandParserRegistry.create()
+            cmd =3D 'ld -o arch/x86/entry/vdso/vdso64.so.dbg -shared --has=
h-style=3Dboth --build-id=3Dsha1 --no-undefined  --eh-frame-hdr -Bsymbolic =
-z noexecstack -m elf_x86_64 -soname linux-vdso.so.1 -z max-page-size=3D409=
6 -T arch/x86/entry/vdso/vdso.lds arch/x86/entry/vdso/vdso-note.o arch/x86/=
entry/vdso/vclock_gettime.o arch/x86/entry/vdso/vgetcpu.o arch/x86/entry/vd=
so/vgetrandom.o arch/x86/entry/vdso/vgetrandom-chacha.o; if readelf -rW arc=
h/x86/entry/vdso/vdso64.so.dbg | grep -v _NONE | grep -q " R_\w*_"; then (e=
cho >&2 "arch/x86/entry/vdso/vdso64.so.dbg: dynamic relocations are not sup=
ported"; rm -f arch/x86/entry/vdso/vdso64.so.dbg; /bin/false); fi'  # type:=
 ignore
