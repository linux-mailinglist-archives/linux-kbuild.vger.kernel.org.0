...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 77543160FC0
	for <lists+linux-kbuild@lfdr.de>; Mon, 17 Feb 2020 11:16:48 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1728698AbgBQKQr (ORCPT <rfc822;lists+linux-kbuild@lfdr.de>);
        Mon, 17 Feb 2020 05:16:47 -0500
Received: from foss.arm.com ([217.140.110.172]:33304 "EHLO foss.arm.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1729126AbgBQKQr (ORCPT <rfc822;linux-kbuild@vger.kernel.org>);
        Mon, 17 Feb 2020 05:16:47 -0500
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 0F9FE30E;
        Mon, 17 Feb 2020 02:16:47 -0800 (PST)
Received: from [10.1.196.72] (e119884-lin.cambridge.arm.com [10.1.196.72])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 0752C3F6CF;
        Mon, 17 Feb 2020 02:16:44 -0800 (PST)
...
X-Pep-Version: 2.0
Message-ID: <7b2b8e5a-c276-4dfe-3fac-afc03cda4e3d@arm.com>
Date:   Mon, 17 Feb 2020 10:16:43 +0000
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:68.0) Gecko/20100101
 Thunderbird/68.4.1
MIME-Version: 1.0
In-Reply-To: <CAK7LNARTD88U1ZBxMU3fCDb1KxF=PavhgoUzqTt6ar9-+7eMQA@mail.gmail.com>
Content-Type: multipart/mixed;
 boundary="------------354280995B4C9C1CD3DCC1FF"
...
>> @@ -35,6 +35,10 @@ ld-option =3D $(success,$(LD) -v $(1))
>>  # Return y if the assembler supports <instr>, n otherwise
>>  as-instr =3D $(success,printf "%b\n" "$(1)" | $(CC) $(CLANG_FLAGS) -c=
 -x assembler -o /dev/null -)
>>
>> +# $(as-option,<flag>)
>> +# Return y if the assembler supports <flag>, n otherwise
>> +as-option =3D$(success, $(CC) $(CLANG_FLAGS) $(1) -c -x assembler /de=
v/null -o /dev/zero)
>> +
>=20
>=20
