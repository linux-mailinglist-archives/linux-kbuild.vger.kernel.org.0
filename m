Return-Path: <linux-kbuild+bounces-13312-lists+linux-kbuild=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-kbuild@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id SIASB5+bEGoYawYAu9opvQ
	(envelope-from <linux-kbuild+bounces-13312-lists+linux-kbuild=lfdr.de@vger.kernel.org>)
	for <lists+linux-kbuild@lfdr.de>; Fri, 22 May 2026 20:08:31 +0200
X-Original-To: lists+linux-kbuild@lfdr.de
Received: from tor.lore.kernel.org (tor.lore.kernel.org [172.105.105.114])
	by mail.lfdr.de (Postfix) with ESMTPS id 5A4845B8D0D
	for <lists+linux-kbuild@lfdr.de>; Fri, 22 May 2026 20:08:30 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by tor.lore.kernel.org (Postfix) with ESMTP id 5095F302B826
	for <lists+linux-kbuild@lfdr.de>; Fri, 22 May 2026 18:05:14 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 7ECF13672B1;
...
X-Spamd-Result: default: False [1.04 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-13312-lists,linux-kbuild=lfdr.de];
	...
	DBL_BLOCKED_OPENRESOLVER(0.00)[makrotopia.org:mid,makrotopia.org:email,tor.lore.kernel.org:rdns,tor.lore.kernel.org:helo,checkpatch.pl:url,self.name:url,ex.map:url,args.jobs:url,addr:email,linetype.property:url,n:email,0.0.0.10:email]
X-Rspamd-Queue-Id: 5A4845B8D0D
