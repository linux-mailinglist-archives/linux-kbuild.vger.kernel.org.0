...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 57F7C142832
	for <lists+linux-kbuild@lfdr.de>; Mon, 20 Jan 2020 11:26:42 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726451AbgATK0l (ORCPT <rfc822;lists+linux-kbuild@lfdr.de>);
        Mon, 20 Jan 2020 05:26:41 -0500
Received: from foss.arm.com ([217.140.110.172]:58072 "EHLO foss.arm.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726125AbgATK0l (ORCPT <rfc822;linux-kbuild@vger.kernel.org>);
        Mon, 20 Jan 2020 05:26:41 -0500
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 0F69030E;
        Mon, 20 Jan 2020 02:26:40 -0800 (PST)
Received: from [10.1.196.72] (e119884-lin.cambridge.arm.com [10.1.196.72])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 0B51A3F68E;
        Mon, 20 Jan 2020 02:26:37 -0800 (PST)
...
X-Pep-Version: 2.0
Message-ID: <d730423a-b5f7-8e4d-4269-f07e5a372ae2@arm.com>
Date:   Mon, 20 Jan 2020 10:26:36 +0000
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:68.0) Gecko/20100101
 Thunderbird/68.2.2
MIME-Version: 1.0
In-Reply-To: <20200117113351.GF26090@arrakis.emea.arm.com>
Content-Type: multipart/mixed;
 boundary="------------67DDAC0FAD126CC7D08BE605"
...
>> +as-option =3D $(success, $(CC) $(CLANG_FLAGS) $(1) -E -x assembler /d=
ev/null -o /dev/null)
>=20
...
Not sure of your experiments for MTE, the kernel is built with clang but =
uses
the GNU assembler. The -Wa, option is passed down to the assembler (GNU) =
which
honors it.

Said that, I agree with Masahiro Yamada about the "-c" option to be used =
in
place of "-E" and on that sense I provided a patch to Amit last December =
which
