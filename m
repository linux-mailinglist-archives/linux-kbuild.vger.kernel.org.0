...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id EADFC14A0E4
	for <lists+linux-kbuild@lfdr.de>; Mon, 27 Jan 2020 10:33:41 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1729606AbgA0JdL (ORCPT <rfc822;lists+linux-kbuild@lfdr.de>);
        Mon, 27 Jan 2020 04:33:11 -0500
Received: from foss.arm.com ([217.140.110.172]:41616 "EHLO foss.arm.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1729575AbgA0JdL (ORCPT <rfc822;linux-kbuild@vger.kernel.org>);
        Mon, 27 Jan 2020 04:33:11 -0500
Received: from usa-sjc-imap-foss1.foss.arm.com (unknown [10.121.207.14])
        by usa-sjc-mx-foss1.foss.arm.com (Postfix) with ESMTP id 92E6B113E;
        Mon, 27 Jan 2020 01:33:10 -0800 (PST)
Received: from [10.1.196.72] (e119884-lin.cambridge.arm.com [10.1.196.72])
        by usa-sjc-imap-foss1.foss.arm.com (Postfix) with ESMTPSA id 928E03F67D;
        Mon, 27 Jan 2020 01:33:08 -0800 (PST)
...
References: <1579774839-19562-1-git-send-email-amit.kachhap@arm.com>
 ...
 <CAK7LNAShhOCpdoVveQ1C1VupDEYOv2UJp4iSTnyyFQ=eTko+uw@mail.gmail.com>
From:   Vincenzo Frascino <vincenzo.frascino@arm.com>
X-Pep-Version: 2.0
Message-ID: <4c17cbb1-1eda-9880-d6be-55ab2c744429@arm.com>
Date:   Mon, 27 Jan 2020 09:33:07 +0000
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:68.0) Gecko/20100101
 Thunderbird/68.4.1
MIME-Version: 1.0
In-Reply-To: <CAK7LNAShhOCpdoVveQ1C1VupDEYOv2UJp4iSTnyyFQ=eTko+uw@mail.gmail.com>
Content-Type: multipart/mixed;
 boundary="------------4681AA36F57964C9B883491C"
...
--------------4681AA36F57964C9B883491C
Content-Type: text/plain; charset=utf-8
Content-Transfer-Encoding: quoted-printable

Hi Masahiro,

On 26/01/2020 14:45, Masahiro Yamada wrote:
...
>>
>> No /dev/zero because otherwise I get a warning that says that I am try=
ing to
>> compile an object into the same file.
>>
>> If I invert /dev/zero and /dev/null this trashes the compilation. It t=
ook me a
...
$ aarch64-none-linux-gnu-gcc -c -x assembler /dev/null -o /dev/null

Assembler messages:
Fatal error: The input '/dev/null' and output '/dev/null' files are the s=
ame
