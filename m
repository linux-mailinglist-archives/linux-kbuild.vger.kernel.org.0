Return-Path: <linux-kbuild+bounces-12199-lists+linux-kbuild=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-kbuild@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id sNEcOcZkwWkjSwQAu9opvQ
	(envelope-from <linux-kbuild+bounces-12199-lists+linux-kbuild=lfdr.de@vger.kernel.org>)
	for <lists+linux-kbuild@lfdr.de>; Mon, 23 Mar 2026 17:05:26 +0100
X-Original-To: lists+linux-kbuild@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [IPv6:2600:3c09:e001:a7::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 923722F78C2
	for <lists+linux-kbuild@lfdr.de>; Mon, 23 Mar 2026 17:05:26 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id EDE0F30E1DB6
	for <lists+linux-kbuild@lfdr.de>; Mon, 23 Mar 2026 15:29:15 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id 4C0C33C9EDE;
...
X-Spamd-Result: default: False [3.84 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-12199-lists,linux-kbuild=lfdr.de];
	FROM_HAS_DN(0.00)[];
