Return-Path: <linux-kbuild+bounces-13892-lists+linux-kbuild=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-kbuild@lfdr.de
Received: from mail.lfdr.de
	by mail.lfdr.de with LMTP
	id 4eF6JgB2PmoFGgkAu9opvQ
	(envelope-from <linux-kbuild+bounces-13892-lists+linux-kbuild=lfdr.de@vger.kernel.org>)
	for <lists+linux-kbuild@lfdr.de>; Fri, 26 Jun 2026 14:52:16 +0200
X-Original-To: lists+linux-kbuild@lfdr.de
Received: from sin.lore.kernel.org (sin.lore.kernel.org [IPv6:2600:3c15:e001:75::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 95F496CD2C6
	for <lists+linux-kbuild@lfdr.de>; Fri, 26 Jun 2026 14:52:15 +0200 (CEST)
Authentication-Results: mail.lfdr.de;
	dkim=pass header.d=debian.org header.s=smtpauto.stravinsky header.b=Fgnb7x9i;
	spf=pass (mail.lfdr.de: domain of "linux-kbuild+bounces-13892-lists+linux-kbuild=lfdr.de@vger.kernel.org" designates 2600:3c15:e001:75::12fc:5321 as permitted sender) smtp.mailfrom="linux-kbuild+bounces-13892-lists+linux-kbuild=lfdr.de@vger.kernel.org";
	dmarc=pass (policy=none) header.from=debian.org;
	arc=pass ("subspace.kernel.org:s=arc-20240116:i=1")
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sin.lore.kernel.org (Postfix) with ESMTP id 3FDC1301CF70
	for <lists+linux-kbuild@lfdr.de>; Fri, 26 Jun 2026 12:51:00 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A84F63F54D9;
	Fri, 26 Jun 2026 12:50:47 +0000 (UTC)
X-Original-To: linux-kbuild@vger.kernel.org
Received: from stravinsky.debian.org (stravinsky.debian.org [82.195.75.108])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E747D3F4DFF;
	Fri, 26 Jun 2026 12:50:45 +0000 (UTC)
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1782478247; cv=none; b=ofHLoNMAaCNrqN+JGP6taNlNC1Iy0mpw5l1zrYT/bwjr8eaMXLrRhDU9vgr4HDnjzT/7Nm+6pXy6ozS0kaEb73N+CVbqMTxEFfJuKOVTaCCRsL86FaQi6K04m6SpQW5GovGtmNraTijDyznXd/XwtWP43q1UVbhd+zZo8slVwoE=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1782478247; c=relaxed/simple;
	bh=S9+k0EvmGeiwpIqXaiVZP4NhRlMrVQvIMBjcrNBR694=;
	h=From:Date:Subject:MIME-Version:Content-Type:Message-Id:References:
	 In-Reply-To:To:Cc; b=e84+IOLKsENpx9sVfVsjFYr5vAcTeLqkJNamDeZ3lMEnpZk1l65WuPdjTPmUlLyKr6gTfYCCtoaEsoOfATgDZtQUjpoyJ+Vdbr7c+Q0k6TcFAq3pq4LBupzuVOLphKIVfjXuGP0XnM2hKbs7RF2p+QD9AJvtT9h67CjIio0/D3M=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=none dis=none) header.from=debian.org; spf=pass smtp.mailfrom=debian.org; dkim=pass (2048-bit key) header.d=debian.org header.i=@debian.org header.b=Fgnb7x9i; arc=none smtp.client-ip=82.195.75.108
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed; d=debian.org;
	s=smtpauto.stravinsky; h=X-Debian-User:Cc:To:In-Reply-To:References:
	Message-Id:Content-Transfer-Encoding:Content-Type:MIME-Version:Subject:Date:
	From:Reply-To:Content-ID:Content-Description;
	bh=dQEQhB4BiNyqAoXPdt73dpA9f+/69Smo4LhC59uFaUY=; b=Fgnb7x9i/t/kyzOoCezhDs3f4/
	;
Received: from authenticated-user
	...
	id 1wd615-003ylD-23;
	Fri, 26 Jun 2026 12:50:44 +0000
From: Breno Leitao <leitao@debian.org>
Date: Fri, 26 Jun 2026 05:50:12 -0700
Subject: [PATCH v7 3/9] bootconfig: render embedded bootconfig as a kernel
...
Message-Id: <20260626-bootconfig_using_tools-v7-3-24ab72139c29@debian.org>
...
X-Developer-Signature: v=1; a=openpgp-sha256; l=9598; i=leitao@debian.org;
 ...
 b=
...
X-Spamd-Result: default: False [-0.66 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	TAGGED_FROM(0.00)[bounces-13892-lists,linux-kbuild=lfdr.de];
