Return-Path: <linux-kbuild+bounces-11913-lists+linux-kbuild=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-kbuild@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id iP56NcgytGn4igAAu9opvQ
	(envelope-from <linux-kbuild+bounces-11913-lists+linux-kbuild=lfdr.de@vger.kernel.org>)
	for <lists+linux-kbuild@lfdr.de>; Fri, 13 Mar 2026 16:52:40 +0100
X-Original-To: lists+linux-kbuild@lfdr.de
Received: from sto.lore.kernel.org (sto.lore.kernel.org [172.232.135.74])
	by mail.lfdr.de (Postfix) with ESMTPS id 6C05C2865F9
	for <lists+linux-kbuild@lfdr.de>; Fri, 13 Mar 2026 16:52:40 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sto.lore.kernel.org (Postfix) with ESMTP id B5D4C3007B95
	for <lists+linux-kbuild@lfdr.de>; Fri, 13 Mar 2026 15:52:39 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id BEBB335F5E1;
...
X-Spamd-Result: default: False [3.84 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-11913-lists,linux-kbuild=lfdr.de];
	FROM_HAS_DN(0.00)[];
