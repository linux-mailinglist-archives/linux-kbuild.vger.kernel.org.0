Return-Path: <linux-kbuild+bounces-13069-lists+linux-kbuild=lfdr.de@vger.kernel.org>
Delivered-To: lists+linux-kbuild@lfdr.de
Received: from mail.lfdr.de
	by lfdr with LMTP
	id sKoCNGjP/GlhTwAAu9opvQ
	(envelope-from <linux-kbuild+bounces-13069-lists+linux-kbuild=lfdr.de@vger.kernel.org>)
	for <lists+linux-kbuild@lfdr.de>; Thu, 07 May 2026 19:44:08 +0200
X-Original-To: lists+linux-kbuild@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [172.234.253.10])
	by mail.lfdr.de (Postfix) with ESMTPS id 294584ED045
	for <lists+linux-kbuild@lfdr.de>; Thu, 07 May 2026 19:44:08 +0200 (CEST)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id EBDE0308CE30
	for <lists+linux-kbuild@lfdr.de>; Thu,  7 May 2026 17:39:31 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id A0BE845348A;
	Thu,  7 May 2026 17:39:31 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=tngtech.com header.i=@tngtech.com header.b="Illu9Jr5"
X-Original-To: linux-kbuild@vger.kernel.org
Received: from mailgw02.zimbra-vnc.de (mailgw02.zimbra-vnc.de [148.251.102.236])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id E161E16F27F;
	Thu,  7 May 2026 17:39:28 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=148.251.102.236
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1778175571; cv=none; b=Vlvw2yTnMh3iTOuaPNTxqGK0djwzeoi0Z16n5WXHwfKCFf8Rb29UagqAqYYuL5pWyl5MgE2tSRO49v+P6t5wesl+gUcSwsueW+u+8feK98pSwlgQxVXsgKDSzTYzNi1nTPC70TuLZDP4lQigTIJXZpCt+JPl+BBeDGoTCxypsdU=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1778175571; c=relaxed/simple;
	bh=Us6Z57tYSjD374jGCMG5dUAIrbq+Fx1XwLJ7/89acSg=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=qF9SCYIPSb1lvpNvUQKyrdND6drQDBxyRXf38+niTS4tTWeEjlsiYgd23RUW+f424SJOveXmBS2Jjrw52fcNpiE5gLegIWXl7DDF/TypGdXipPyb41Upi5/5o/zc9Hn01goIFTZlXov79mezbTrO2EFkuxX+QX28OQULhXrB/h8=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=tngtech.com; spf=pass smtp.mailfrom=tngtech.com; dkim=pass (2048-bit key) header.d=tngtech.com header.i=@tngtech.com header.b=Illu9Jr5; arc=none smtp.client-ip=148.251.102.236
Authentication-Results: smtp.subspace.kernel.org; dmarc=pass (p=quarantine dis=none) header.from=tngtech.com
Authentication-Results: smtp.subspace.kernel.org; spf=pass smtp.mailfrom=tngtech.com
Received: from zmproxy.tng.vnc.biz (zimbra-vnc.tngtech.com [35.234.71.156])
	by mailgw02.zimbra-vnc.de (Postfix) with ESMTPS id 6B1BC200BA;
	Thu,  7 May 2026 19:39:27 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by zmproxy.tng.vnc.biz (Postfix) with ESMTP id 3678C1FB174;
	Thu,  7 May 2026 19:39:27 +0200 (CEST)
Received: from zmproxy.tng.vnc.biz ([127.0.0.1])
 by localhost (zmproxy.tng.vnc.biz [127.0.0.1]) (amavis, port 10032)
 with ESMTP id GQLEkJfhB2QR; Thu,  7 May 2026 19:39:25 +0200 (CEST)
Received: from localhost (localhost [127.0.0.1])
	by zmproxy.tng.vnc.biz (Postfix) with ESMTP id 9C8041FB1CB;
	Thu,  7 May 2026 19:39:25 +0200 (CEST)
DKIM-Filter: OpenDKIM Filter v2.10.3 zmproxy.tng.vnc.biz 9C8041FB1CB
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=tngtech.com;
	s=B14491C6-869D-11EB-BB6C-8DD33D883B31; t=1778175565;
	bh=Upa+knMIMPn2aGz+z6bVqvuGWZULeok8xIgUvXdFoQQ=;
	h=From:To:Subject:Date:Message-ID:MIME-Version;
	b=
X-Virus-Scanned: amavis at zmproxy.tng.vnc.biz
Received: from zmproxy.tng.vnc.biz ([127.0.0.1])
 by localhost (zmproxy.tng.vnc.biz [127.0.0.1]) (amavis, port 10026)
 with ESMTP id oj4oYqnAAoje; Thu,  7 May 2026 19:39:25 +0200 (CEST)
Received: from luis-Precision-5480.. (ipservice-092-209-239-167.092.209.pools.vodafone-ip.de [92.209.239.167])
	by zmproxy.tng.vnc.biz (Postfix) with ESMTPSA id 33D2C1FB174;
	Thu,  7 May 2026 19:39:25 +0200 (CEST)
...
Subject: [PATCH v6 05/15] scripts/sbom: add cmd graph generation
Date: Thu,  7 May 2026 19:38:17 +0200
Message-ID: <20260507173827.70949-6-luis.augenstein@tngtech.com>
...
X-Spamd-Result: default: False [-0.66 / 15.00];
	...
	HAS_LIST_UNSUB(-0.01)[];
	RCVD_TLS_LAST(0.00)[];
	TAGGED_FROM(0.00)[bounces-13069-lists,linux-kbuild=lfdr.de];
	DBL_BLOCKED_OPENRESOLVER(0.00)[tngtech.com:email,tngtech.com:mid,tngtech.com:dkim,sea.lore.kernel.org:helo,sea.lore.kernel.org:rdns,target_path.name:url];
...
---
 ...
 scripts/sbom/sbom/config.py                   | 150 +++++++++++++++-
...
index c7f23d6eb30..05da21fa6fe 100644
...
+            continue
+        resolve_file_path =3D os.path.join(obj_tree, input_file.lstrip("=
@"))
...
index c1ac9ad5737..2f84731ba25 100644
...
+    )
     parser.add_argument(
         "--debug",
         action=3D"store_true",
@@ -25,6 +93,28 @@ def _parse_cli_arguments(parser: argparse.ArgumentPars=
er) -> dict[str, bool]:
...
+
     ...
     return args
=20
@@ -37,10 +127,66 @@ def get_config() -> KernelSbomConfig:
